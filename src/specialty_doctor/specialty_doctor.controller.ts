...
export class SpecialtyDoctorController {
  constructor(private readonly specialtyDoctorService: SpecialtyDoctorService) {}
  ...
  @Patch(':id')
  update(@Param('id') id: string, @Body() updateSpecialtyDoctorDto: UpdateSpecialtyDoctorDto) {
