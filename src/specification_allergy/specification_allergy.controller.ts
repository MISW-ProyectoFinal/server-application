...
export class SpecificationAllergyController {
  ...
  create(@Body() createSpecificationAllergyDto: CreateSpecificationAllergyDto) {
    return this.specificationAllergyService.create(
  ...
  update(
    @Param('id') id: string,
    @Body() updateSpecificationAllergyDto: UpdateSpecificationAllergyDto,
  ) {
    return this.specificationAllergyService.update(
      +id,
      updateSpecificationAllergyDto,
    );
  }
