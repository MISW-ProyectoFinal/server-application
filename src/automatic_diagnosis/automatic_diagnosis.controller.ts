...
export class AutomaticDiagnosisController {
  constructor(private readonly automaticDiagnosisService: AutomaticDiagnosisService) {}
  ...
  @Patch(':id')
  update(@Param('id') id: string, @Body() updateAutomaticDiagnosisDto: UpdateAutomaticDiagnosisDto) {
    return this.automaticDiagnosisService.update(+id, updateAutomaticDiagnosisDto);
  }
