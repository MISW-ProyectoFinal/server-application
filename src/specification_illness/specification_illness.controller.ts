...
export class SpecificationIllnessController {
  ...
  create(@Body() createSpecificationIllnessDto: CreateSpecificationIllnessDto) {
    return this.specificationIllnessService.create(
  ...
  update(
    @Param('id') id: string,
    @Body() updateSpecificationIllnessDto: UpdateSpecificationIllnessDto,
  ) {
    return this.specificationIllnessService.update(
      +id,
      updateSpecificationIllnessDto,
    );
  }
